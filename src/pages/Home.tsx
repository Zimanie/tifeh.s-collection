...
export default function Home() {
  ...
  return <main>
    ...
    <div className="service-bar"><span><Truck size={15} /> Fast delivery, carefully packed</span><span><ShieldCheck size={15} /> Secure checkout</span><span>Easy exchanges</span><span>Curated for your everyday</span></div>
